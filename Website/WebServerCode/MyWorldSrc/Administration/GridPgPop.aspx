<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GridPgPop.aspx.vb" Inherits="Administration_GridPgPop" %>
     ...
     <td class="PopBodyBg" style="height: 300px; vertical-align: top;">
      <form id="aspnetForm" method="post" runat="server">
       <table style="width: 100%;">
        <tr>
         <td>
          <b id="TagName" runat="server"></b> 
          <asp:DropDownList ID="Regions" runat="server" AutoPostBack="true">
          </asp:DropDownList>
         </td>
        </tr>
       ...
       <input type="hidden" id="KeyID" runat="server" class="NoShow" />
      </form>
     </td>
    </tr>
   </table>
